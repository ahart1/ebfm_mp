...
# Arguments required by RunMultiSpeciesProdWithCeiling() function
 ...
 # PickStatusMeasureOption: Indicates how status measures are chosen, default=1
    MSE_PickStatusMeasureOption <- "ALL"
...
# Run 100 simulations with timing 
    system.time(
RunMultiSpeciesProdWithCeiling(ScriptWorkDir=MSE_ScriptWorkDir, WorkDir=MSE_WorkDir, OUTPUTdirName=MSE_OUTPUTdirName, Nsim=MSE_Nsim, Nyr=MSE_Nyr, SpeciesNames=MSE_SpeciesNames, PercentFmsy=MSE_PercentFmsy, alpha=MSE_alpha, Predators=MSE_Predators, Pelagics=MSE_Pelagics, Guildmembership=MSE_Guildmembership, 
...
# Run 1000 simulations with timing 
    ...
    #MSE_TempSSDir <- "/Users/ahart2/Research/ebfm_mp/arhart/temp"
    # OUTPUTdirName: This is the working directory where the output from this function will be stored 
    MSE_OUTPUTdirName <- "UpdatedModel_AFSData_Run3_Sim1000_AllInds"  
    # Nsim: Number of model simulations to run, default=1
    MSE_Nsim <- 1000
    # Nyr: Number of years model projects forward in time, default=5
    MSE_Nyr <- 30
