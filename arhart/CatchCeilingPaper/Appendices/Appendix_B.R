...
FormatAppendixData <- function(FileName=NULL, Nsim=NULL, CeilingValue=NULL, BMSY=NULL, PercentFmsy=NULL, Indicator_On_or_Off=NULL, FishPrices=NULL, StartAvg = 1, EndAvg = nrow(Biomass)){
  ...
  for(i in 1:Nsim){
    ...
    for(irow in StartAvg:EndAvg){
      CatchDiversityTemp <-  c(CatchDiversityTemp, diversity(Catch[irow,], index="shannon"))
    }
...
AppB_Result <- AppB_Result_Ceiling200000$Results # Just look at 200000mt catch ceiling
...
AppB_Result70 <- AppB_Result70_Ceiling200000$Results
...
############ Look at performance metrics over different number of simulations #####


FormattedData <- read.table("/Users/ahart2/Research/ebfm_mp/arhart/CatchCeilingPaper/CatchCeilingPaperResults_Formatted_Final")
DataSummary <- summary(FormattedData)

# Data with 50000 mt catch ceiling, indicators turned on and target fishing mortality set to Fmsy evaluated here

boxplot(FormattedData$FrequencySSOverfished[1:100], FormattedData$FrequencySSOverfished[1:200], FormattedData$FrequencySSOverfished[1:500], FormattedData$FrequencySSOverfished[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Frequency Single Species Overfished")
boxplot(FormattedData$FrequencyAggregateCollapse[1:100], FormattedData$FrequencyAggregateCollapse[1:200], FormattedData$FrequencyAggregateCollapse[1:500], FormattedData$FrequencyAggregateCollapse[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Frequency Aggregate Collapse")
boxplot(FormattedData$PiscivoreCatch[1:100], FormattedData$PiscivoreCatch[1:200], FormattedData$PiscivoreCatch[1:500], FormattedData$PiscivoreCatch[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Piscivore Catch")
boxplot(FormattedData$BenthivoreCatch[1:100], FormattedData$BenthivoreCatch[1:200], FormattedData$BenthivoreCatch[1:500], FormattedData$BenthivoreCatch[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Benthivore Catch")
boxplot(FormattedData$PlanktivoreCatch[1:100], FormattedData$PlanktivoreCatch[1:200], FormattedData$PlanktivoreCatch[1:500], FormattedData$PlanktivoreCatch[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Planktivore Catch")
boxplot(FormattedData$ElasmobranchCatch[1:100], FormattedData$ElasmobranchCatch[1:200], FormattedData$ElasmobranchCatch[1:500], FormattedData$ElasmobranchCatch[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Elasmobranch Catch")
boxplot(FormattedData$SystemBiomass[1:100], FormattedData$SystemBiomass[1:200], FormattedData$SystemBiomass[1:500], FormattedData$SystemBiomass[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "System Biomass")
boxplot(FormattedData$SystemCatch[1:100], FormattedData$SystemCatch[1:200], FormattedData$SystemCatch[1:500], FormattedData$SystemCatch[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "System Catch")
boxplot(FormattedData$BiomassDiversity[1:100], FormattedData$BiomassDiversity[1:200], FormattedData$BiomassDiversity[1:500], FormattedData$BiomassDiversity[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Biomass Diversity")
boxplot(FormattedData$CatchDiversity[1:100], FormattedData$CatchDiversity[1:200], FormattedData$CatchDiversity[1:500], FormattedData$CatchDiversity[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Catch Diversity")
boxplot(FormattedData$TotalRevenue[1:100], FormattedData$TotalRevenue[1:200], FormattedData$TotalRevenue[1:500], FormattedData$TotalRevenue[1:1000],
        names = c("100", "200", "500", "1000"),
        xlab = "Number of Simulations", 
        ylab = "Total Revenue")
